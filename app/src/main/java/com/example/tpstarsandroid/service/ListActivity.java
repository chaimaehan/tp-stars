...
public class ListActivity extends AppCompatActivity {
    ...
    public void init() {
        service.create(new Star("brad pitt", R.mipmap.bradpitt, 3.5f));
        service.create(new Star("angelina jolie", R.mipmap.angelinajolie, 3));
        service.create(new Star("leonar dodi caprio", R.mipmap.leonardodicaprio, 5));
        ...
        service.create(new Star("tom hanks", R.mipmap.tomhanks, 3));
